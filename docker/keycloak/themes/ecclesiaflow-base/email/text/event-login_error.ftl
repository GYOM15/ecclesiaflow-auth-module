${msg("eventLoginErrorTitle","Failed login attempt")}
...
${msg("eventLoginErrorHint","This notification was sent because brute force protection is enabled on your account.")}
