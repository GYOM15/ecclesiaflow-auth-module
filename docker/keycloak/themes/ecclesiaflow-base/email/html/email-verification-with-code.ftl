...
<tr>
    <td style="padding: 36px 36px 32px;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" style="padding: 8px 0 24px;">
            <span style="display: inline-block; font-family: 'JetBrains Mono', 'SF Mono', 'Fira Code', monospace; font-size: 36px; font-weight: 700; letter-spacing: 8px; color: #3B52F6; background: linear-gradient(135deg, rgba(59,82,246,0.08), rgba(59,82,246,0.03)); padding: 18px 32px; border-radius: 14px; border: 2px dashed rgba(59,82,246,0.25);">${code}</span>
        </td></tr></table>
