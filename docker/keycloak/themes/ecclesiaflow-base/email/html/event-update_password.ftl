    ...
    <td style="padding: 28px 24px 24px;">
        ...
        <table cellpadding="0" cellspacing="0" border="0"><tr>
            <td style="width: 56px; height: 56px; background: linear-gradient(135deg, rgba(20,184,166,0.12), rgba(20,184,166,0.06)); border: 1px solid rgba(20,184,166,0.15); border-radius: 16px; text-align: center; vertical-align: middle;">
                <span style="font-size: 20px; font-weight: 700; color: #0d9488;">&#10003;</span>
            </td>
        </tr></table>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin: 16px 0 24px;">
            <tr>
                <td style="padding: 18px 20px; background: #ffffff; border: 1px solid #99f6e4; border-left: 4px solid #14B8A6; border-radius: 12px;">
        ...
        <p style="font-size: 15px; color: #334155; line-height: 1.7; margin: 0 0 16px;">${msg("eventUpdatePasswordWarning","If you did NOT change your password, your account may be compromised. Please reset your password immediately and contact your church administrator.")}</p>
