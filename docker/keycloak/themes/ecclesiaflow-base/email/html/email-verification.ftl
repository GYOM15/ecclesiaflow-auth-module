...
<tr>
    <td style="padding: 36px 36px 32px;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" style="padding: 8px 0 24px;">
            <a href="${link}" style="display: inline-block; padding: 14px 36px; background: linear-gradient(135deg, #3B52F6 0%, #5469F7 100%); color: #ffffff; text-decoration: none; border-radius: 12px; font-weight: 600; font-size: 15px; letter-spacing: 0.2px; box-shadow: 0 4px 14px rgba(59,82,246,0.3);">${msg("emailVerificationBtn","Verify my email")}</a>
        </td></tr></table>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0"><tr>
            <td style="font-size: 12px; color: #94a3b8; word-break: break-all; line-height: 1.5; padding: 14px 16px; background: #f8fafc; border-radius: 10px; border: 1px dashed #e2e8f0;">
                ...
                <a href="${link}" style="color: #3B52F6; text-decoration: none;">${link}</a>
            </td>
        </tr></table>
