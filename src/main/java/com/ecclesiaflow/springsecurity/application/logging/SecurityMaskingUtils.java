...
public final class SecurityMaskingUtils {
    ...
    public static String maskResetLink(String link) {
    ...
    public static String maskAny(Object value) {
        ...
        if (raw.startsWith("http://") || raw.startsWith("https://")) {
            return raw.contains("token=") ? maskResetLink(raw) : "[URL]";
        }
    ...
    public static String sanitizeInfra(String msg) {
        ...
        // bare domains like example.com (ignore emails handled elsewhere) -> [HOST]
