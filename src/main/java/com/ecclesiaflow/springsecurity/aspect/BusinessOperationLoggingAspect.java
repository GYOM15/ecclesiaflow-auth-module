...
public class BusinessOperationLoggingAspect {
     ...
     */
    @Pointcut("execution(* com.ecclesiaflow.springsecurity.services.impl.AuthenticationServiceImpl.getAuthenticatedMember(..))")
    public void memberAuthentication() {}

    /**
     * Pointcut pour le rafraîchissement de token
     */
    @Pointcut("execution(* com.ecclesiaflow.springsecurity.services.impl.AuthenticationServiceImpl.refreshToken(..))")
